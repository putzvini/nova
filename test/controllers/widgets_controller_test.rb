...
class WidgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create widget" do
    assert_difference("Widget.count") do
      post widgets_url, params: { widget: { active: @widget.active, description: @widget.description, name: @widget.name } }
    end
  ...
  test "should update widget" do
    patch widget_url(@widget), params: { widget: { active: @widget.active, description: @widget.description, name: @widget.name } }
